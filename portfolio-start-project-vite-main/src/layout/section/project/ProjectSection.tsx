...
export const ProjectSection = () => {
    ...
    return (
        <FlexWrapperSection>
            <Container displayF={"flex"} jContent={"center"}>
                <ProjectSectionStyled>
                    <TitleSection title={"Projects"}/>
                    <ProjectBlock nameProject={state.project1.nameProject} description={state.project1.description}
                                  photo={state.project1.photo}  />
                    <ProjectBlock nameProject={state.project2.nameProject} description={state.project2.description}
                                  photo={state.project2.photo}/>
                    <ProjectBlock nameProject={state.project3.nameProject} description={state.project3.description}
                                  photo={state.project3.photo}/>
                </ProjectSectionStyled>
            </Container>
        </FlexWrapperSection>
    );
